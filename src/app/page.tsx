...
export default function HomePage() {
  ...
  function createDrum(form: Omit<Drum, "id" | "status" | "imagesScanned" | "items">) {
    const drum: Drum = { ...form, id: crypto.randomUUID(), status: "Active", imagesScanned: 0, scanImages: [], items: [] };
